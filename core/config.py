...
class ConfigManager:
    ...
    public_keys = {
        # activity
        "twitch_url": "https://www.twitch.tv/arnaud0204/",
        # bot settings
        ...
        "thread_auto_close_response": "Ce ticket a été fermé automatiquement en raison d'une inactivité après {timeout}.",
        "thread_creation_response": "L'équipe du personnel vous répondra dans les plus brefs délais.",
        "thread_creation_footer": "Votre message a été envoyé",
        "thread_contact_silently": True,
        "thread_self_closable_creation_footer": "Cliquez sur le verrou pour fermer le ticket.",
        "thread_creation_title": "Ticket créé",
        "thread_close_footer": "Répondre créera un nouveau ticket",
        "thread_close_title": "Ticket ferméé",
        "thread_close_response": "{closer.mention} fermé ce ticket.",
        "thread_self_close_response": "Vous avez fermé ce ticket.",
        "thread_move_title": "Ticket déplacé",
        "thread_move_notify": False,
        "thread_move_notify_mods": True,
        "thread_move_response": "Ce ticket a été déplacé.",
        "cooldown_thread_title": "Message non envoyé!",
        "cooldown_thread_response": "Vous devez attendre {delta} avant de pouvoir me recontacter.",
        "disabled_new_thread_title": "Non livrés",
        "disabled_new_thread_response": "Nous n'acceptons pas de nouveaux ticket.",
        "disabled_new_thread_footer": "Veuillez réessayer plus tard...",
        "disabled_current_thread_title": "Non livrés",
        "disabled_current_thread_response": "Nous n'acceptons aucun message.",
        "disabled_current_thread_footer": "Veuillez réessayer plus tard...",
        "transfer_reactions": True,
        "close_on_leave": False,
        "close_on_leave_reason": "Le destinataire a quitté le serveur.",
        ...
        "confirm_thread_creation_title": "Confirmer la création du ticket",
        "confirm_thread_response": "Réagissez pour confirmer la création du fil qui contactera directement le personnel.",
        "confirm_thread_creation_accept": "\u2705",
        "confirm_thread_creation_deny": "\U0001F6AB",
        # regex
        "use_regex_autotrigger": True,
    }
